/**
 * Prompt templates ported from vulnhuntr/prompts.py
 * Contains all vulnerability-specific templates, system prompt,
 * analysis approach, guidelines, and bypass examples.
 */

// ---------------------------------------------------------------------------
// Vulnerability-specific analysis templates
// ---------------------------------------------------------------------------

export const LFI_TEMPLATE = `
...
// ---------------------------------------------------------------------------
// Vulnerability-specific bypasses and prompt mapping
// ---------------------------------------------------------------------------
...
export const INITIAL_ANALYSIS_PROMPT_TEMPLATE = `
...
export const README_SUMMARY_PROMPT_TEMPLATE = `
...
export const SYS_PROMPT_TEMPLATE = `
...
// ---------------------------------------------------------------------------
// XML prompt builders (mirrors xml_models.py)
// ---------------------------------------------------------------------------
