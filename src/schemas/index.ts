...
export const ContextCodeSchema = z.object({
  ...
  reason: z.string().describe("Brief reason why this function's code is needed"),
  code_line: z.string().describe("The single line of code where this context object is referenced"),
});
...
export const ResponseSchema = z.object({
  ...
  vulnerability_types: z.array(VulnType).describe("Identified vulnerability types"),
  context_code: z.array(ContextCodeSchema).describe("Requested code context items"),
});
