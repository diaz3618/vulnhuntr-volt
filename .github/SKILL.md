...
- **Has its own agent system**: [repos/vulnhuntr/SKILL.md](repos/vulnhuntr/SKILL.md)
- When working in this directory, defer to its SKILL.md
...
│  └─ Load: [repos/vulnhuntr/SKILL.md](repos/vulnhuntr/SKILL.md)
│
...
Action: Reference repos/vulnhuntr/SKILL.md (it has its own orchestrator)
```
...
- See [repos/vulnhuntr/SKILL.md](repos/vulnhuntr/SKILL.md) for complete constraints
...
- Sub-Agent: Vulnhuntr's own SKILL.md system
- Directory: repos/vulnhuntr/

**Action**:

```
1. Reference repos/vulnhuntr/SKILL.md (don't duplicate logic)
